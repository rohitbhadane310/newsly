export const data = [
  ...
  {
    title:
      "India has suspended Chinese nationals' tourist visas: Global airlines body",
  ...
  {
    title:
      "Woman constable carries 86-year-old for 5 km in Gujarat’s Kutch desert",
    author: "Apaar Sharma",
  ...
  {
    title:
      "Noida DM Suhas LY reaches badminton final at Paralympics, assures India of a medal",
    author: "Anmol Sharma",
    description:
      "Noida District Magistrate (DM) Suhas LY, who is representing India in para badminton at the Tokyo Paralympics, has entered the final of the mens singles SL4 category. He defeated Setiawan Fredy of Indonesia in the semi-final with the scoreline of 21-9, 21-15. Earlier in the day, Pramod Bhagat also reached the final of the mens singles SL3 event.",
  ...
  {
    title:
      "Cristiano Ronaldo to wear jersey number seven at Manchester United again",
    author: "Anmol Sharma",
    description:
